...
class EntityTemplateUserRepositoryImplTest {
    ...
    @Test
    void saveUser() throws ExecutionException, InterruptedException {
        ...
        Mono<UserEntity> mono = repository.saveUser(UserEntity.builder().build());
        assertNull(mono.toFuture().get());
    }
}